...
Write an amaizing cover letter demonstrating how my abilities align with the requirements for the {{position}} at {{company}}. Use the job description below as a guide.
