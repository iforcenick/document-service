...
Write the 3 paragraphs of short but reasonable cover letter for a {{position}} job at {{company}} using the below job description as a reference.
DONT'T WRITE IT LIKE A TEMPLATE AND WRITE SENTENCES and PARAGRAPHS SHORT.
...
Write the 3 paragraphs of short but reasonable cover letter using the below job description as a reference.
DONT'T WRITE IT LIKE A TEMPLATE AND WRITE SENTENCES and PARAGRAPHS SHORT.
